        ...
        <div className="p-4 space-y-6">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div className="text-center md:text-left space-y-1">
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-slate-100">Manager Dashboard</h2>
                    <p className="text-gray-500 dark:text-slate-400 font-medium tracking-wide text-sm uppercase">
                        Current Bookings
                    </p>
            ...
            <div className="space-y-4">
                {currentBookings.length === 0 ? (
                    <div className="flex flex-col items-center justify-center p-12 bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-dashed border-gray-300 dark:border-slate-800 text-center space-y-4">
                        <div className="w-16 h-16 bg-gray-50 dark:bg-slate-800 rounded-full flex items-center justify-center">
                            <CalendarClock className="w-8 h-8 text-gray-400 dark:text-slate-500" />
                        </div>
                        <div>
                            <p className="text-lg font-medium text-gray-900 dark:text-slate-100">No active bookings</p>
