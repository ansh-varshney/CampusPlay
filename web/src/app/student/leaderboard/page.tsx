                            ...
                            <CardContent className="p-4 flex items-center gap-4">
                                ...
                                <div className="flex-1">
                                    <h3 className="font-bold text-gray-800 dark:text-slate-100 flex items-center gap-2">
                                        ...
                                        {student.id === userId && (
                                            <span className="text-[10px] bg-[#004d40] dark:bg-teal-600 text-white px-1.5 py-0.5 rounded">
                                                YOU
                                            </span>
                                        )}
                                    </h3>
                                ...
                                <div className="text-right">
                                    <div className="font-black text-lg text-gray-800 dark:text-slate-100">
                                        {student.points || 0}
                                    </div>
                                    <div className="text-xs text-gray-400 dark:text-slate-400">pts</div>
                                </div>
                            </CardContent>
                        </Card>
                    ))
            ...
            {userRank >= 5 && (
                <div className="pt-4 border-t border-dashed">
                    ...
                    <Card className="ring-2 ring-[#004d40]">
                        <CardContent className="p-4 flex items-center gap-4">
                            <div className="w-10 h-10 rounded-full bg-[#004d40]/10 dark:bg-teal-950/60 flex items-center justify-center font-bold text-[#004d40] dark:text-teal-400">
                                {userRank + 1}
                            </div>
                            <div className="flex-1">
                                <h3 className="font-bold text-gray-800 dark:text-slate-100">You</h3>
