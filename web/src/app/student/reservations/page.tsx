    ...
    return (
        <div className="p-4 md:p-8 space-y-6">
            <div className="space-y-1">
                <h1 className="text-2xl font-bold text-gray-900 dark:text-slate-100">My Reservations</h1>
                <p className="text-sm text-gray-500 dark:text-slate-400">Track your bookings and active sessions</p>
            </div>
